            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: isLight
                    ...
                    : const Color(0xFF53C1F9).withOpacity( 0.14),
                width: 0.9,
              ),
            ),
            child: Stack(
              ...
              BoxShadow(
                color: (isLight
                        ...
                        : hasUnread
                            ? const Color(0xFF53C1F9)
                            : Colors.black)
                    .withOpacity( isLight ? 0.12 : (hasUnread ? 0.26 : 0.18)),
                blurRadius: isLight ? 10 : (hasUnread ? 18 : 12),
                offset: const Offset(0, 6),
              ),
              if (isLight)
                BoxShadow(
                  color: const Color(0xFFB79BFF).withOpacity( 0.09),
                  blurRadius: 12,
  ...
  Future<List<_ProfileRelationUser>> _relationUsersForIds(
    ...
    for (final uid in ids) {
      ...
      String readString(List<String> keys) {
        for (final key in keys) {
          final fromPublic = (publicData[key] as String? ?? '').trim();
          if (fromPublic.isNotEmpty) return fromPublic;
          final fromPrivate = (privateData[key] as String? ?? '').trim();
          if (fromPrivate.isNotEmpty) return fromPrivate;
        }
        return '';
      }

      final username = readString(const ['username']);
      final displayName = readString(const ['displayName', 'fullName']);
      final firstName = readString(const ['firstName']);
      final lastName = readString(const ['lastName']);
      final avatar = readString(
          const ['profilePictureUrl', 'profileImageUrl', 'avatarUrl']);
      ...
      final name = displayName.isNotEmpty
          ...
          : ([firstName, lastName]
              ...
              ? [firstName, lastName]
                  ...
                  .join(' ')
                  .trim()
              : (username.isNotEmpty ? username : trimmedUid));
    ...
    final bubble = Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          ...
          if (isLight)
            BoxShadow(
              color: const Color(0xFFB79BFF).withOpacity( 0.08),
              blurRadius: 14,
    ...
    final tile = Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isLight
              ? const Color(0xFFA7BFFF)
              : const Color(0xFF53C1F9).withOpacity( 0.26),
        ),
        boxShadow: isLight
            ? [
                BoxShadow(
                ...
                BoxShadow(
                  color: const Color(0xFFB79BFF).withOpacity( 0.07),
                  blurRadius: 12,
                  offset: const Offset(0, 5),
                ),
              ]
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: isLight
            ? null
            : Border.all(
                color: const Color(0xFF53C1F9).withOpacity( 0.12)),
      ),
      child: ClipRRect(
        borderRadius: BorderRadius.circular(18),
        child: Column(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: isSelected
                ? [
                    BoxShadow(
                      color: const Color(0xFF7FE4FF).withOpacity( 0.24),
                      blurRadius: 10,
                      offset: const Offset(0, 4),
                    ),
                    BoxShadow(
                      color: const Color(0xFFA993FF).withOpacity( 0.2),
                      blurRadius: 12,
                      offset: const Offset(0, 5),
                    ),
                  ]
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          shadowColor: isLight
                              ? const Color(0xFFB79BFF).withOpacity( 0.22)
                              : Colors.transparent,
                          backgroundColor:
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: isLight
                              ? borderColor
                              : const Color(0xFF53C1F9).withOpacity( 0.3),
                        ),
                        boxShadow: isLight
                            ? [
                                BoxShadow(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color:
                              const Color(0xFF7D72FF).withOpacity( 0.32),
                          blurRadius: 14,
                          offset: const Offset(0, 7),
                        ),
                      ],
              ...
              style: TextStyle(
                ...
                shadows: isComplete
                    ? [
                        Shadow(
                          color:
                              const Color(0xFF4725A8).withOpacity( 0.35),
                          blurRadius: 10,
                          offset: const Offset(0, 2),
                        ),
                      ]
