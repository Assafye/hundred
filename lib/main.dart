    ...
    runApp(
      BootstrapErrorApp(
        message: isMissingAndroidFirebaseOptions
            ? 'Firebase לא הוגדר לאנדרואיד. יש להוסיף google-services.json לנתיב android/app ולהגדיר Google Services ב-Gradle.\n\n${e.message ?? e.code}'
            : 'שגיאת אתחול פלטפורמה: ${e.message ?? e.code}',
      ),
    );
  } catch (e) {
    await ShareFlowLogService.log(
